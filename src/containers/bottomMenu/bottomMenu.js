...
function BottomMenu(props) {
    return (
        <div className='absolute md:hidden w-[100%] h-[8vh] bottom-0 flex justify-between items-center px-[5%] bg-primary border-t-[0.01rem] border-darkClose'>
            <div className='relative'>
                <HomeIcon className='w-[1.3rem] text-iconsColor duration-75 hover:bg-gray-50 hover:duration-75' />
                <div className='absolute top-0 right-0 bg-blueSpecial w-[6px] h-[6px] rounded-full'></div>
            </div>
            
            <MagnifyingGlassIcon className='w-[1.3rem] text-iconsColor duration-75 hover:bg-gray-50 hover:duration-75' />
